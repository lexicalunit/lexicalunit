...
\begin{position}
\begin{itemize}
\item Maintained GitLab's DevOps infrastructure while adding new features such as Feature Flags
\item Created the solution and \href{https://www.youtube.com/watch?v=ymgwt2NUbd4}{a video demo} for Green-Blue deployments with GitLab CI
\end{itemize}
\end{position}
...
\begin{itemize}
\item \textbf{Languages:} TypeScript/JS/ES6, Python, ruby, C/Obj-C/\Cplusplus, Scala, Go, Zsh/Bash
