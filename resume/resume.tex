...
\begin{resume}
  ...
  \begin{position}
    \begin{itemize}
      ...
      \item Grew SpellBot to 3k+ monthly active users over 7 years with a self-sustaining business model
      \item Co-developing \href{https://convoke.games/}{Convoke}, a next-generation webcam Magic: The Gathering platform
      \item Scaled Convoke to 20000+ active users within the first 4 months of launch
    \end{itemize}
  \end{position}
