...
% \item Primarily wrote Python ETL code leveraging our MasterMind framework % TODO: Change "Primarily" here
...
\location{Austin, TX}
\dates{March 2012 -- February 2014}
\begin{position}
\begin{itemize}
...
\location{Austin, TX}
\dates{August 2006 -- February 2012}
\begin{position}
\begin{itemize}
\item Designed HFA sonar display currently deployed on approximately 75\% of US submarines % TODO: remove 75% stat
...
% \item Developed a high level of proficiency with modern \Cplusplus~techniques and design
...
% \item Often worked very closely with Lockheed Martin on ARCI development
\end{itemize}
\end{position}
...
\item \href{https://atom.io/packages/multi-wrap-guide}{multi-wrap-guide}: Multiple wrap guides for the Atom editor%, \href{http://blog.atom.io/2015/08/06/new-package-roundup.html}{featured in a github blog post}
