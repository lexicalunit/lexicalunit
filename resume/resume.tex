...
\begin{resume}
  ...
  \begin{itemize}
    ...
    \item \textbf{Tools:} git, Node, Terraform, GraphQL, Docker, Kubernetes, JIRA, Redis
    \item \textbf{Services:} Amazon Web Services, Databricks, Grafana, Kafka, Sentry, PagerDuty
    \item \textbf{Databases:} PostgreSQL, Snowflake, MySQL, MongoDB, Vertica/Greenplum
    \item \textbf{Libraries:} Django, React, Ruby on Rails, Boost, SQLAlchemy, AKKA
