...
\begin{resume}
  ...
  \begin{itemize}
    ...
    \item \textbf{Tooling:} pytest, Webpack, Git, GitHub, GitLab, GraphQL, Linear, JIRA, CMake, ODBC
    \item \textbf{Cloud \& Platforms:} AWS, Databricks, CircleCI, Grafana, Sentry, PagerDuty
    \item \textbf{Databases:} PostgreSQL, Snowflake, Redis, MySQL, MongoDB, Vertica/Greenplum
    \item \textbf{Practices:} Agile, Scrum, Distributed System Design, Test/Behavior Driven Development
    \item \textbf{Markup:} YAML, JSON, HTML/CSS/LESS/Sass, Markdown, \LaTeX, Jinja, Handlebars
