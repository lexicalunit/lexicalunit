...
\begin{resume}
  ...
  \begin{position}
    \begin{itemize}
      ...
      \item Grew \href{https://spellbot.io}{SpellBot} to 18k+ monthly games over 7 years with a self-sustaining model
  ...
  \begin{position}
    \begin{itemize}
      ...
      \item Built agentic interfaces to our GraphQL API using LangChain
    \end{itemize}
  \end{position}
  ...
  \begin{position}
    \begin{itemize}
      \item Built core features for InVision Studio, a design tool used by 5 million designers
  ...
  \begin{position}
    \begin{itemize}
      \item Designed the \href{http://nanodbc.io}{nanodbc} library, now used by used by the \href{https://github.com/r-dbi/odbc}{R programming language}
      \item Built robust Web API resources using Flask, gunicorn, and Nginx
