...
% Macros
\newcommand{\Cpp}{C\kern-0.05em \raisebox{0.4ex}{\tiny\textbf{++}}}
...
\begin{resume}
  ...
  \begin{itemize}
    \item \textbf{Languages:} Python, TypeScript/JavaScript, \Cpp, SQL, Shell, Go, Rust, Ruby, Scala, Swift
    \item \textbf{Frameworks:} Django, Node.js, Flask, FastAPI, React, Rails, Boost, SQLAlchemy, Akka
    \item \textbf{AI/ML:} LLMs, Scikit-learn, PyTorch, LangChain, MCP, Classification, Machine Learning
  ...
  % Convoke & SpellBot
  \employer{\textbf{Builder.io}}
  \title{Senior Software Engineer - Fusion Team}
  \location{Remote}
  \dates{05/2026 -- Present}
  \begin{position}
    \begin{itemize}
      \item Designed and built out AWS VPC support for Builder.io, itself hosted on GCP
      \item Collaborated with a cross-functional team and AI services to deliver features
    \end{itemize}
  \end{position}
  ...
  \begin{position}
    \begin{itemize}
      ...
      \item Built \href{https://www.montecarlodata.com/platform/operations-agent}{agentic interfaces} to our GraphQL API using LangChain, boosting user engagement
    \end{itemize}
  \end{position}
  ...
  \begin{position}
    \begin{itemize}
      ...
      \item Designed \href{https://www.checkhq.com/?contact-form=false}{embedded payroll} components that directly secured multiple enterprise partnerships
  ...
  \begin{position}
    \begin{itemize}
      \item Instrumented iOS applications with event tracking using Objective-\Cpp~and Swift
  ...
  \begin{position}
    \begin{itemize}
      ...
      \item Architected Web API resources using Flask, gunicorn, and Nginx
        ...
        % \item Sharpened \Cpp~and Python skills by attending PyCon, PyData, and \Cpp~conferences
  ...
  \begin{position}
    \begin{itemize}
      ...
      \item Held Secret security clearance
        ...
        % \item Developed a high level of expertise with modern \Cpp~techniques and design
  ...
  \begin{itemize}
    \item \href{http://nanodbc.io}{nanodbc}: A small \Cpp~wrapper for ODBC, used by the \href{https://github.com/r-dbi/odbc}{R programming language}
    ...
    \item \href{https://github.com/lexicalunit/dotfiles}{dotfiles}: My personalized machine configuration management system
      ...
      % \item \href{https://github.com/lexicalunit/dict}{\Cpp~dict}: Proof-of-concept \Cpp~dict class with Python-like features
  \end{itemize}
